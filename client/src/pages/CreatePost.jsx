...
const API="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";
const CreatePost = () => {
    ...
    <section className='max-w-7xl mx-auto'>
     <div>
              ...
              <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
                Create imaginatice and visually stunning
                images generated by DALL-E AI and share them with
                the community
              </p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>
            You have created the image, you can share it
